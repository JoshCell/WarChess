 ...
 */
  ...
  app.get('/signup', function (req, res) {
    res.sendFile( __dirname + '/Warchat/views/signup.html');
  });
  ...
  app.get('/css/foundation.min.css', function (req, res) {
    res.sendFile(__dirname + '/Warchat/views/css/foundation.min.css');
  });

  app.get('/css/normalize.css', function (req, res) {
    res.sendFile(__dirname + '/Warchat/views/css/normalize.css');
  });
  
  app.get('/js/foundation.min.js', function (req, res) {
    res.sendFile(__dirname + '/Warchat/views/js/foundation.min.js');
  });
  /** *** *** */
    
    /*app.get('/js/chat.js', function (req, res){
        res.sendFile(__dirname + 'Warchat/views/js/chat.js');
    });*/
    
    /*app.get('/js/moment-width-locales.min.js', function(req, res){
        res.sendFile(__dirname + '/Warchat/views/js/moment-with-locales.min.js');
    });*/
    
  /** *** *** */
  
  app.get('*', function(req, res) {
    res.sendFile( __dirname + '/Warchat/views/chat.html');
  });
