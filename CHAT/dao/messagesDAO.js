...
//Debe ser construido con un objeto conectado a la base de datos

function MessageDAO(db){
    //Si el constructor es llamado sin el operados 'new' entonces 'this' apunta al objeto global, muestra una advertencia y lo llama correctamente.
    
    if(false == (this instanceof MessageDAO)){
        console.log('WARNING: MessageDAO contructor called without "new" operator');
        return new MessageDAO(db);
    }
    
    //Coleccion 'messages' en la base de datos
