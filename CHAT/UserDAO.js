//Utilidad para encriptar el password del usuario
var bcrypt = require('bcrypt-nodejs');

// Data Access Object (DAO) para 'users', debe ser construido con un objeto conectado a la base de datos.

function UserDAO(db){
    //Si el constructor es llamado sin el operador 'new', muestra una advertencia y lo llama correctamente.
    
    if(false == (this instanceof UserDAO)){
        console.log('WARNING: UserDAO constructor called without "new" operator');
        return new UserDAO(db);
    }
    //Colección de 'users' en la base de datos
    ...
    this.addUser = function(username, password, email, callback){
        ...
        users.findOne({'_id': username}, function (err, user){
            ...
            if (user) {
                ...
                // Crear el nuevo 'user' con los parámetros dados.
