...
var column = row.selectAll(".square")
    ...
    var imageTerreno = column.append("image")
        ...
        .attr('xlink:href',"img/terreno01.png")
        .on('click', function(d) {
            d.click++;
            if(clickUni==false){
                if ((d.click)%3 == 0 ) { d3.select(this).attr('xlink:href',"img/terreno01.png"); }
                if ((d.click)%3 == 1 ) { d3.select(this).attr('xlink:href',"img/terreno02.png"); }
                if ((d.click)%3 == 2 ) { d3.select(this).attr('xlink:href',"img/terreno03.png"); }

            }
        });
        //.on('mouseover', function(d){
        //d3.select(this).attr('xlink:href', "public/img/selectZone.svg");
        //d3.select(this).insert('image',":first-child").attr("width", 95).attr("height", 95).attr('xlink:href', "public/img/selectZone.svg");
    //});
    ...
    var squareUnit = column.append("image")
        ...
        .on('click', function(d){
            ...
            if(clickUni==true){
                ...
                if ((d.click)%2 == 0 ) { var imgRed = d3.select(this).attr('xlink:href',"img/infanteria01red.png").attr("id", idCont + "red"); unidadesRed.push(imgRed);}
                if ((d.click)%2 == 1 ) { d3.select(this).attr('xlink:href',"img/infanteria01blue.png").attr("id", idCont + "blue");} 
                idCont++;
            }
            if(clickborr == true){
...
var bloqueBotones = d3.select("#grid")
    ...
    bloqueBotones.append("image")
        ...
        .attr("width", 40)
        .attr("height", 40)
        .attr('xlink:href', "img/IconoUnidades.png")
        .on("click", function(d){
            clickUni = clickUni == false ? true : false;
            if(clickUni == true){
                d3.select(this).attr('xlink:href',"img/IconoTerreno.png");
            }else{  d3.select(this).attr('xlink:href',"img/IconoUnidades.png");
            }
...
var buttonStats = menu.selectAll(".buttonStats")
    ...
    var buttonImg = buttonStats.append("image")
            ...
            .attr("x", function(d) { return d.x;})
            .attr("y", function(d) { return d.y;})
            .attr('xlink:href',"img/buttonStatsRed.png")
            .on("mousedown", function(d){
               ButStaBol = true; 
                d3.select(this).attr('xlink:href',"img/buttonStatsGreen.png")
            ...
            .on("mouseup", function(d){
               ButStaBol = false; 
                d3.select(this).attr('xlink:href',"img/buttonStatsRed.png");
