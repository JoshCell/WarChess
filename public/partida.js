var unidades = {
    ...
    mec01 : { num: 3, nombre: "tanque", ataque:100, defensa:25, PV:150, movimiento: 4},
    mec02 : { num: 4, nombre: "artilleria", ataque:75, defensa:20, PV:130, movimiento: 3}
}

var escenario = d3.select(document.getElementById("escenario").contentDocument);
//var unit = escenario.select("#LAYERA8").append("image").attr("x", 0).attr("y", 0).attr("href:link", "img/BaseBlue.png");

var svgScenario = escenario.select("#Warchess_scenario");
    svgScenario.select("#LAYERA8").append("image").attr("xlink:href", "img/BaseBlue.png");
